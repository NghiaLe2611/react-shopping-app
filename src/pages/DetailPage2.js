...
import ComparePopup from '../components/UI/ComparePopup';
...
const DetailPage = () => {
    ...
    const confirmCompare = () => {
        ...
        const category = product.category === 'smartphone' ? 'dien-thoai' : 'may-tinh-bang';
        ...
        if (list.length < 2) {
            ...
            navigate(`/so-sanh/${category}?${link}`);
        }
    };
    ...
    let sliderContent, compareModalContent, infoModalContent;
    ...
    return (
		<Fragment>
            ...
            <ComparePopup isComparing={isComparing} setIsComparing={setIsComparing}
                listCompare={listCompare}
                setListCompare={setListCompare}
                addToCompare={addToCompare} 
                removeItemCompare={removeItemCompare}
                confirmCompare={confirmCompare}
            />

            <CompareModalWrapper isComparing={isComparing} setIsComparing={setIsComparing}/>
		</Fragment>
	);
}
