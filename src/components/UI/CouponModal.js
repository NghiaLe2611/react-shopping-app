...
const CouponModal = (props) => {
    ...
    const { showCouponModal, showCouponModalHandler, closeCouponModalHandler,
        showCouponPopup, setShowCouponPopup
        ...
        <Fragment>
            {
                shouldRenderCouponModal && (
                    <Modal isShowModal={showCouponModalHandler} closeModal={closeCouponModal} 
                                    ...
                                    codeStatus && (
                                        <p style={{color: 'red', fontSize: 12, width: '100%', marginTop: 10}}>
                                            { 
                                                ...
                                                codeStatus === 2 ? 'Mã giảm giá không hợp lệ' : codeStatus === 3 ? 'Bạn chưa đủ điều kiện để áp dụng mã' : 
                                                codeStatus === 4 ? 'Mã giảm giá đã được áp dụng' : null
                                            }
                                        </p>
                                    )
                                }
