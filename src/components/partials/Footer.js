                ...
                <div className={classes['wrap-footer']}>
                    ...
                    <div className={classes['footer-block']}>
                        ...
                        <ul className={`${classes.menu} ${classes.social}`}>
                            <li><a rel='noreferrer' href='https://www.facebook.com/' title='Facebook'></a></li>
                            <li><a rel='noreferrer' href='https://www.youtube.com/' title='Youtube'></a></li>
                            <li><a rel='noreferrer' href='https://www.instagram.com/' title='Instagram'></a></li>
                        </ul>
                    </div>
                </div>
            </div>
